  ...
  return (
    <div>
      <div className="flex items-center justify-start gap-6 tab-lg:mx-[8rem]  des:mx-[8rem] mx-[1rem]  m-auto">
        ...
        <p className="text-[16px] font-semibold text-[#db4444] ">
          {sectionName}
        </p>
      </div>
      <div className="flex justify-between items-center m-auto mx-[1rem] des:mx-[8rem] tab-lg:mx-[8rem] pt-4">
        ...
        {arrows && (
          <div className="hidden items-center gap-1 tab-lg:block">
        ...
        {button && (
          <div>
            <button className="text-[12px] tab:text-[16px] px-4 py-1  bg-[#db4444] tab:px-8 tab:py-2 capitalize rounded text-white tab">
              View all
            </button>
          </div>
        )}
